#!/usr/bin/env python3
"""Complete Turn 7 for playtest-session-001."""
...
INPUT_RESPONSE = {
    ...
    "narrative": "신은 불어나는 설교의 열기를 곧장 짓누르기보다, 그 안에 숨어든 허영과 경쟁심을 키우는 편이 낫다고 판단했다. 같은 구호를 외치던 이들 사이에서 누가 진정한 신앙을 품었는지, 누가 군중의 환호를 탐하는지에 대한 의심이 번지며 결속이 서서히 갈라지기 시작한다. 신의 속삭임은 공개된 공포보다 더 조용하게, 그러나 더 깊숙이 공동체의 심장을 파고든다.",
    "intensity": "mid",
    "scale": "regional",
}
